...
export const PROFILES = {
  ...
  ibm_proprinter: {
    label: 'IBM Proprinter',
    pins: 9,
    dpi_h: 120,
    dpi_v: 72,
    dot_diameter_mm: 0.38,
    dot_softness: 0.26,
    ink_density: 0.95,
    passes: 2,
    jitter_mm: 0.05,
  ...
  panasonic_kx: {
    label: 'Panasonic KX-P',
    pins: 24,
    dpi_h: 360,
    dpi_v: 180,
    dot_diameter_mm: 0.22,
    dot_softness: 0.2,
    ink_density: 0.88,
    passes: 1,
    jitter_mm: 0.02,
...
export const SYSTEM_PRESETS = [
  ...
  },
  {
    ...
    maxSize: 8000,
    wearLayers: [
      { pattern: 'pin_skip', strength: 25 },
      { pattern: 'smudge', strength: 20 },
    ],
    seed: 42,
    softBlur: false,
    invert: false,
