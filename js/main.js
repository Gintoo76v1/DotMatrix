...
const pointerUp = (e) => {
  ...
  if (pointers.length === 0) { isDragging = false; canvasWrapper.releasePointerCapture(e.pointerId); }
};
...
async function performRender() {
  ...
  renderBtn.disabled = true; document.getElementById("status").textContent = "Rendern...";
  try {
